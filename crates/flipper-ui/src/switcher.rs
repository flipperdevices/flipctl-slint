...
/// One card frame: a rectangle and its four corner radii.
...
impl Switcher {
    ...
    fn place(&self, card: &Card, e: f32) -> Option<Placed> {
        ...
        // and 1 or more is a card behind it.
        ...
        Some(Placed {
            ...
            alpha,
            pos_clamped,
            // The neighbours keep their picture at full strength: a strip of the
            // app is the whole point of a background card, and fading it with
            // distance leaves an empty one.
            image_alpha: alpha,
            img_x,
            img_y,
            deep,
...
pub struct Placed {
    ...
    pub alpha: f32,
    /// 0 focused, 1 a card behind it, in between while it moves. Drives the crossfade
